    ...
    >
        ...
        {navbarItems.map(item => {
          ...
          return (
            <NavLink
              ...
              to={item.path}
              className={({ isActive }) =>
                `flex w-full items-center rounded-2xl border pl-5 py-3 text-sm font-medium ${
                  isActive
      ...
      {user && (
        ...
        >
          ...
          >
            <span className='truncate text-sm font-medium text-slate-200'>{user.displayName}</span>
